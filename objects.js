export const lectures = {
  "async-and-event-loop-in-javascript": {
    ...
    description:
      "Разбираем вопросы связанные с асинхронностью в JavaScript: стек вызовов функций, движок выполнения JS, что такое микротаски и макротаски, очереди и что попадает в microtask queue и macrotask queue, EventLoop и цикл работы браузера",
  ...
  "plus-and-minus-of-using-typescript": {
    ...
    description:
      "Разбираем плюсы и минусы использования TypeScript. Безопасность кода, строгая типизация, спорные моменты, документирование кода в TS. Type casting, enum, any и другие опасные моменты",
...
export const articles = {
  "how-i-got-tired-of-creating-files-and-folders": {
    ...
    description:
      "Рассуждаю о проблеме регулярного создания файлов и о том, как поддержать архитектуру и автоматизировать рутину. Написал утилиту на Go для генерации структур файлов по шаблонам",
